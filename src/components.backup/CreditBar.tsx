...
const CreditBar: React.FC<CreditBarProps> = ({ onPurchaseCredits }) => {
          ...
          <div className="flex items-center gap-4">
            <div className="bg-gradient-to-r from-yellow-500/20 to-amber-500/20 backdrop-blur-sm px-4 py-2 rounded-xl border border-yellow-500/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white font-semibold text-lg">{user.credits.toLocaleString()}</span>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">{user.credits} crediti disponibili</p>
                      </div>
                    </div>
