    ...
    if (majorEvents.includes(eventName) || userFormData) {
      try {
        ...
        const capiData = {
          ...
          content_name: 'HydroJet Pro - Akumulatorowa Myjka Ciśnieniowa z Zestawem Premium',
          content_category: 'Professional Cleaning Equipment',
          content_ids: 'hydrojet-pro-pressure-washer',
          content_type: 'product',
          value: eventData.value || 298.00,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8">
              Przekształć Swoje Sprzątanie z Mocą i Mobilnością
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Stwierdziło, że mycie stało się szybsze i bardziej skuteczne!</p>
              </div>
...
// Componente Carosello per Myjka Ciśnieniowa
const ProductCarousel = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const [touchStart, setTouchStart] = useState(0);
  const [touchEnd, setTouchEnd] = useState(0);

  // Le immagini del prodotto HydroJet Pro
  const images = [
    "/images/Pressure/1.png",
    "/images/Pressure/3.png",
    "/images/Pressure/4.png",
    "/images/Pressure/5.png",
    "/images/Pressure/kit.gif"
  ];
        ...
        <div className="relative min-h-[300px] max-h-[600px]">
          {images.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`HydroJet Pro - Akumulatorowa Myjka Ciśnieniowa - Widok ${index + 1}`}
...
// Main Component
export default function PressureWasherLanding() {
  ...
  useEffect(() => {
    ...
    trackingUtils.trackGoogleEvent('page_view', {
      page_title: 'HydroJet Pro - Akumulatorowa Myjka Ciśnieniowa z Zestawem Premium - Strona Główna',
  ...
  const handleOrderClick = () => {
    ...
    trackingUtils.trackGoogleEvent('view_item', {
      ...
      value: 298.00,
      items: [{
        item_id: 'hydrojet-pro-pressure-washer',
        item_name: 'HydroJet Pro - Akumulatorowa Myjka Ciśnieniowa z Zestawem Premium',
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      const leadData = {
        ...
        // Dati del prodotto
        product: 'HydroJet Pro - Akumulatorowa Myjka Ciśnieniowa z Zestawem Premium',
        price: 298.00,
        currency: 'PLN',
      ...
      if (response.status === 202) {
        ...
        window.location.href = '/ty-pressure-pl';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 space-y-6">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                💧 HydroJet Pro – Akumulatorowa Myjka Ciśnieniowa
              </h1>

              <p className="text-lg text-gray-700 font-medium">
                <strong>Zestaw premium: 2 akumulatory, pianownica, dysze, filtr, wąż 8,5 m i walizka.</strong>
              </p>

              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">💧 <strong>Mocny strumień ciśnieniowy</strong> – Skuteczne mycie auta, tarasu i kostki</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🔋 <strong>2 akumulatory 4,0Ah</strong> – Długi czas pracy bez kabla</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">📦 <strong>Wąż 8,5 m z filtrem</strong> – Pobór wody z wiadra lub zbiornika</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">⚡ <strong>Szybka wymiana dysz</strong> – Pianownica w zestawie, gotowa do pracy w 60 s</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🎒 <strong>Lekka i przenośna</strong> – Walizka transportowa dla łatwego przechowywania</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🔧 <strong>Zestaw premium</strong> – Dysze, filtr wody, szybkozłączki, adapter do kranu</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <h2 style={{
                  ...
                  💧 HydroJet Pro – Akumulatorowa myjka ciśnieniowa z zestawem premium, profesjonalna jakość
                </h2>
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>💧 Mocny strumień ciśnieniowy + wąż 8,5m z filtrem + 2 akumulatory w zestawie</span>
                  <span style={{
                    color: 'red',
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>🔋 2 akumulatory w zestawie: Długi czas pracy bez kabla</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>🛠️ Akcesoria w zestawie: 2× bateria, dysza 6-w-1, dysza obrotowa, filtr, pianownica, wąż 8,5 m, walizka</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <div style={{ marginTop: '10px' }}>
                    Dziś tylko: <span style={{ fontSize: '26px' }}>298,00 zł</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 text-sm leading-relaxed mb-3">
                      "Kupiłem HydroJet Pro miesiąc temu i jestem zachwycony! 💧 Mocny strumień to prawdziwa rewolucja – mycie jest niesamowicie skuteczne i szybkie. Dwa akumulatory pozwalają mi pracować przez cały dzień bez przerwy. Umyłem auto, taras i kostkę brukową. To najlepsza myjka ciśnieniowa, jaką miałem!"
                    </p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-bold text-gray-900 text-sm">Piotr K. - Kraków</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                💧 HydroJet Pro – Profesjonalna Myjka Ciśnieniowa dla Najbardziej Wymagających Zadań!
              </h2>
              <p className="text-lg text-gray-700 mb-6">
                <strong>HydroJet Pro</strong> to rewolucyjna akumulatorowa myjka ciśnieniowa, zaprojektowana dla specjalistów, którzy wymagają najwyższej jakości czyszczenia.
              </p>
              <p className="text-lg text-gray-700">
                Mocny strumień ciśnieniowy z <strong>zestawem premium</strong> gwarantuje szybkie i skuteczne czyszczenie, a <strong>dwa akumulatory 4,0Ah</strong> zapewniają długi czas pracy bez kabla.
              </p>
              <p className="text-lg text-gray-700 mb-6 font-semibold bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <strong>Dlaczego warto:</strong> Jedno urządzenie do wszystkiego: auto, rower, elewacja, narzędzia, meble ogrodowe. Bez kabli, bez ograniczeń – tylko czysta wygoda.
              </p>
            </div>
            <div>
              <img
                src="/images/Pressure/kit.gif"
                alt="Myjka ciśnieniowa w użyciu"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <img
                src="/images/Pressure/3.png"
                alt="Cechy myjki ciśnieniowej"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Cechy Profesjonalne HydroJet Pro
              </h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Mocny strumień:</strong> Wydajny strumień ciśnieniowy do skutecznego mycia aut, tarasów i kostki.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>2 Akumulatory w zestawie:</strong> Długi czas pracy dzięki dwom akumulatorom 4,0Ah.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Zestaw premium:</strong> Wąż 8,5 m z filtrem, pianownica, dysze, szybkozłączki, adapter do kranu, walizka.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Mobilność i wygoda:</strong> Lekka konstrukcja, gotowa do pracy w 60 sekund, łatwy transport w walizce.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Mocny Strumień - Czyszczenie Szybkie i Ultra-Skuteczne
            </h2>
            <p className="text-lg text-gray-700">
              Odkryj moc akumulatorowej myjki HydroJet Pro - rewolucyjną technologię, która zmienia standard czyszczenia profesjonalnego.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <img
                src="/images/Pressure/4.png"
                alt="Myjka ciśnieniowa w akcji"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <h3 className="font-bold text-lg mb-2">Mocny Strumień</h3>
                  <p className="text-gray-600">Potężny strumień ciśnieniowy do profesjonalnego czyszczenia.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">🔋</div>
                ...
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">2× bateria 21V, dysza 6-w-1, dysza obrotowa, filtr, pianownica, wąż 8,5 m, walizka, ładowarka szybka</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Co Czyni HydroJet Pro Myjką Ciśnieniową Profesjonalną #1
            </h2>
            <p className="text-lg text-gray-700">
              W przeciwieństwie do zwykłych myjek ciśnieniowych, HydroJet Pro oferuje 2 akumulatory, wąż 8,5 m z filtrem i pełny zestaw premium.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 sm:p-8 overflow-x-auto">
            <div className="min-w-full">
              <div className="hidden md:grid md:grid-cols-3 gap-4 text-center mb-4">
                <div></div>
                <div className="font-bold text-lg">HydroJet Pro</div>
                <div className="font-bold text-lg">Inne</div>
              </div>

              {[
                'Mocny strumień ciśnieniowy',
                '2 akumulatory 4,0Ah w zestawie',
                'Lekka i przenośna konstrukcja',
                'Wąż 8,5 m z filtrem i zestaw premium',
                'Gotowa do pracy w 60 sekund'
              ].map((feature, index) => (
                  ...
                  <div className="md:hidden">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-3 rounded-lg text-center">
                        <div className="font-medium text-green-600 mb-1">HydroJet Pro</div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <FAQ
              question="Czy pobiera wodę z wiadra?"
              answer="Tak, dzięki wężowi z filtrem."
            />
            <FAQ
              question="Czy są dwie baterie w zestawie?"
              answer="Tak, 2x akumulator + ładowarka."
            />
            <FAQ
              question="Do czego się nadaje?"
              answer="Auto, taras, kostka, rower, meble ogrodowe, narzędzia."
            />
            <FAQ
              question="Jak długo pracują akumulatory?"
              answer="Dwa akumulatory 4,0Ah zapewniają długi czas pracy do kilku godzin."
            />
            <FAQ
              question="Czy jest łatwa w obsłudze?"
              answer="Tak, gotowa do pracy w 60 sekund, szybka wymiana dysz, lekka i mobilna."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Opinie klientów o myjce ciśnieniowej
            </h2>
            <p className="text-lg text-gray-700">
            ...
            {[
              {
                name: "Piotr K. - Kraków",
                rating: 5,
                review: "Umyłem auto i taras w godzinę. Mobilność robi różnicę."
              },
              {
                name: "Anna S. - Wrocław",
                rating: 5,
                review: "Wąż 8,5 m i pianownica – super do felg i okien."
              },
              {
                name: "Marek D. - Gdańsk",
                rating: 5,
                review: "Dwie baterie starczają na długie sprzątanie. Walizka na plus."
              },
              {
                name: "Marek F. - Poznań",
                rating: 5,
                review: "Mobilność myjki to duża wygoda. Walizka łatwa do transportu."
              },
              {
                name: "Jakub J. - Lublin",
                rating: 5,
                review: "Profesjonalna myjka ciśnieniowa. Zestaw kompletny i wygodny w użyciu."
              },
              {
                name: "Robert K. - Wrocław",
                rating: 5,
                review: "Skutecznie myje auto i meble ogrodowe. Dwa akumulatory to duża wygoda."
              },
              {
                name: "Paweł N. - Łódź",
                rating: 4,
                review: "Lekka i wydajna. Pianownica świetnie nadaje się do mycia."
              },
              {
                name: "Krzysztof P. - Szczecin",
                rating: 5,
                review: "Wężyć akumulatorową myjkę to wygoda. Zestaw dysz ułatwia pracę."
              },
              {
                name: "Marcin H. - Białystok",
                rating: 5,
                review: "Używam już 6 miesięcy i nadal jestem zachwycony! Myjka ciśnieniowa nadal wydajna, a akumulatory wytrzymują naprawdę długo. Najlepszy zakup!"
              }
            ].map((review, index) => (
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700">
                  "Świetny HydroJet Pro! 💧 Mocny strumień to prawdziwa przyszłość - mycie jest niesamowicie skuteczne i błyskawiczne! Umyłem auto, taras i kostkę brukową bez wysiłku. 2 akumulatory to ogromna wygoda - pracuję cały dzień bez przerw. Najlepsza myjka ciśnieniowa profesjonalna na rynku!"
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Wypróbuj myjkę ciśnieniową z całkowitym bezpieczeństwem dzięki naszej 30-dniowej gwarancji zwrotu pieniędzy. Doświadcz mocy i wygody bezprzewodowego mycia bez ryzyka i odkryj, jak może przekształcić Twoje sprzątanie.
            </p>
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Tylko na dziś: <span className="line-through opacity-75">749,99 zł</span> <span className="text-5xl font-bold">298,00 zł</span>
          </p>
            ...
            <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                <img
                  ...
                  alt="Myjka ciśnieniowa"
                  className="w-12 h-12 md:w-16 md:h-16 rounded-lg border border-gray-200 object-cover flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-gray-900 text-sm md:text-base">💧 HydroJet Pro – Akumulatorowa Myjka Ciśnieniowa</div>
                  <div className="text-xs md:text-sm text-gray-600">Mocna, Przenośna, Gotowa do Pracy</div>
                  <div className="text-xs md:text-sm text-green-600">✅ Darmowa dostawa</div>
                </div>
                <div className="text-right flex-shrink-0">
                  <div className="font-bold text-lg md:text-xl text-gray-900">298,00 zł</div>
