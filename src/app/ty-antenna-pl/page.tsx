    ...
    if (typeof window !== 'undefined' && window.gtag) {
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          currency: 'PLN',
          items: [{
            item_id: 'aerotv-pro-antenna-dvb-t2',
            item_name: 'AeroTV Pro — Antena DVB-T2/HEVC z wzmacniaczem (wewn./zewn.)',
...
const ThankYouPage = () => {
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twoja antena zostanie starannie przygotowana i zapakowana w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      {/* Header Success */}
      <div className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór anteny AeroTV Pro
          </p>
          {orderData?.orderId && (
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-gray-200">
          ...
          <div className="space-y-6">
            {nextSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200">
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg">
                  {step.step}
                </div>
        ...
        {/* Benefits Reminder */}
        <div className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 rounded-2xl text-white p-8 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 5.000 Zadowolonych Klientów
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru nowoczesnej anteny DVB-T2/HEVC z wzmacniaczem.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                ...
                <p className="text-green-700 text-sm">Dostaw na czas</p>
              </div>
