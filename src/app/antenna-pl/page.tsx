    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">AeroTV Pro</h3>
            <p className="text-gray-400 text-sm">
              Nowoczesne anteny DVB-T2/HEVC z wbudowanym wzmacniaczem.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © 2024 AeroTV Pro. Wszelkie prawa zastrzeżone.
            </p>
          ...
          <div className="mt-6 text-xs text-gray-500 max-w-4xl mx-auto">
            AeroTV Pro to marka nowoczesnych anten DVB-T2/HEVC z wbudowanym wzmacniaczem.
...
const ReviewsCarousel = () => {
  ...
  const reviews = [
    "/images/antenna/recensioni/1.jpg",
    "/images/antenna/recensioni/2.jpg",
    "/images/antenna/recensioni/3.jpg",
    "/images/antenna/recensioni/4.jpg",
    "/images/antenna/recensioni/5.jpg",
    "/images/antenna/recensioni/6.jpg",
    "/images/antenna/recensioni/7.jpg",
    "/images/antenna/recensioni/8.jpg"
  ];
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden shadow-2xl border border-emerald-200">
        <div className="aspect-[4/3] relative">
          <img
            ...
            alt={`Opinia klienta ${currentReview + 1} - AeroTV Pro`}
...
// Product carousel for antenna
const ProductCarousel = () => {
  const [selectedImage, setSelectedImage] = useState(0);

  // Antenna images
  const images = [
    "/images/antenna/1.jpg",
    "/images/antenna/2.jpg",
    "/images/antenna/3.jpg",
    "/images/antenna/4.jpg",
    "/images/antenna/5.jpg"
  ];
    ...
    <div className="relative w-full max-w-lg mx-auto bg-white rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="relative aspect-square overflow-hidden">
        <img
          ...
          alt={`AeroTV Pro DVB-T2/HEVC - widok ${selectedImage + 1}`}
...
export default function AntennaLanding() {
  ...
  const handleOrderClick = () => {
    if (typeof window !== 'undefined' && window.fbq) {
      window.fbq('track', 'InitiateCheckout', {
        ...
        content_ids: ['aerotv-pro-antenna-dvb-t2'],
        content_name: 'AeroTV Pro — Antena DVB-T2/HEVC z wzmacniaczem (wewn./zewn.)',
        value: 209.00,
        currency: 'PLN',
        num_items: 1
      });
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      try {
        await fetch('https://primary-production-625c.up.railway.app/webhook/CAPI-Meta', {
          ...
          body: JSON.stringify({
            ...
            product_name: 'AeroTV Pro — Antena DVB-T2/HEVC z wzmacniaczem (wewn./zewn.)',
            value: 209.00,
            currency: 'PLN'
          })
        });
      ...
      const leadData = {
        ...
        // Dati del prodotto
        product: 'AeroTV Pro — Antena DVB-T2/HEVC z wzmacniaczem (wewn./zewn.)',
        price: 209.00,
        currency: 'PLN',
      ...
      if (response.ok) {
        ...
        if (typeof window !== 'undefined' && window.gtag) {
          window.gtag('event', 'conversion', {
            send_to: 'AW-17740732466/xCQtCIjknsIbELKwuItC',
            value: 209.00,
            currency: 'PLN',
        ...
        window.location.href = '/ty-antenna-pl';
      } else {
      ...
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="order-2 space-y-6">
                ...
                <p className="text-lg text-gray-700 font-medium">
                  Krystaliczny obraz, stabilny sygnał i gotowość na 4K. Do domu, mieszkania i domku letniskowego.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Wbudowany wzmacniacz</strong> – stabilny odbiór w trudnych warunkach</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>4K-ready</strong> – obraz i dźwięk najwyższej jakości</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Odbiór wewnątrz i na zewnątrz</strong> – kompaktowa, odporna konstrukcja</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Szybki montaż</strong> – podłącz i oglądaj w kilka minut</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Zasięg dalekiego odbioru</strong></span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Kompatybilna</strong> ze smart TV i dekoderami</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-base"><strong>Lekka, estetyczna</strong> – nowoczesny design</span>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Dlaczego warto wybrać AeroTV Pro?
              </h2>
              <p className="text-lg text-gray-600">
                Standard DVB-T2/HEVC z wbudowanym wzmacniaczem dla najlepszego odbioru
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">DVB-T2/HEVC</h3>
                <p className="text-gray-600">
                  Zgodność z najnowszym standardem nadawania cyfrowego
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">4K-ready</h3>
                <p className="text-gray-600">
                  Obraz i dźwięk najwyższej jakości – gotowy na przyszłość
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Szybki montaż</h3>
                <p className="text-gray-600">
                  Podłącz i oglądaj w kilka minut – wszystko w zestawie
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Wewnętrzny i zewnętrzny montaż – kompaktowa konstrukcja
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Wzmacniacz</h3>
                <p className="text-gray-600">
                  Wbudowany wzmacniacz sygnału dla stabilnego odbioru
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Kompatybilność</h3>
                <p className="text-gray-600">
                  Działa ze smart TV, dekoderami i wszystkimi urządzeniami DVB-T2
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Zdjęcia i opinie od osób, które już używają AeroTV Pro
              </p>
            </div>
            ...
            <div className="text-center mt-8">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-emerald-200 max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 text-sm">
                  Wszystkie opinie pochodzą od rzeczywistych klientów, którzy zakupili i testują AeroTV Pro w swoich domach
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-200">
                  ...
                  <p className="text-gray-700 mb-3">
                    "Fantastyczna antena! Od razu zauważyłem różnicę w jakości obrazu. Netflix i Disney+ działają płynnie przez Smart TV, a kanały DVB-T2 odbierają się krystalicznie czysto. Wzmacniacz robi robotę - mam stabilny sygnał nawet w deszczu."
                  </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-200">
                  ...
                  <p className="text-gray-700 mb-3">
                    "Montaż trwał dosłownie 10 minut. Podłączyłam do Samsung Smart TV i od razu wszystko działa. Oglądamy Player, TVP VOD, Prime Video - wszystko w jednym miejscu. Polecam każdemu kto chce połączyć tradycyjną TV z nowoczesnymi platformami."
                  </p>
                  <div className="text-xs text-gray-500">
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-200">
                  ...
                  <p className="text-gray-700 mb-3">
                    "Mieszkam za miastem i zawsze miałem problemy z odbiorem. AeroTV Pro zmieniła wszystko - stabilny sygnał 24/7, nie ma już 'klocków' na ekranie. Jakość 4K to inna liga. Najlepsza inwestycja w tym roku!"
                  </p>
                  <div className="text-xs text-gray-500">
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-200">
                  ...
                  <p className="text-gray-700 mb-3">
                    "Sceptycznie podchodziłam do zakupu, ale jestem pozytywnie zaskoczona. Antena jest kompaktowa, łatwa w montażu (nawet ja sama dałam radę), a efekt przewyższył oczekiwania. Wreszcie mogę oglądać HBO Max i Apple TV+ bez buforowania."
                  </p>
                  <div className="text-xs text-gray-500">
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-200">
                  ...
                  <p className="text-gray-700 mb-3">
                    "Profesjonalne wykonanie i świetna jakość. Używam zarówno do kanałów naziemnych jak i streamingu przez LG Smart TV. Wreszcie jeden system obsługuje wszystko - od TVP przez Netflix po Disney+. Stosunek jakości do ceny rewelacyjny."
                  </p>
                  <div className="text-xs text-gray-500">
              ...
              <div className="text-center mt-12">
                <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white p-6 rounded-2xl shadow-xl">
                  ...
                  <p className="mb-4 opacity-90">
                    Zamów AeroTV Pro już dziś i ciesz się krystalicznym obrazem oraz dostępem do wszystkich platform streamingowych
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative">
                  <img
                    src="/images/antenna/2.jpg"
                    alt="AeroTV Pro - dostęp do platform streamingowych"
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-gradient-to-br from-white to-indigo-50 p-8 rounded-2xl shadow-xl border border-indigo-100">
                  <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                    🎬 Wszystkie Platformy Streamingowe w Jednym Miejscu
                  </h2>

                  <p className="text-lg text-gray-700 mb-6">
                    Dzięki AeroTV Pro i połączeniu z Smart TV lub dekodera z internetem, oglądasz <strong>wszystko</strong> — od tradycyjnej telewizji po najnowsze filmy i seriale.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-4 rounded-xl">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-bold">Netflix + Prime Video</h3>
                          <p className="text-sm opacity-90">Filmy, seriale, dokumenty w 4K</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4 rounded-xl">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-bold">Disney+ + Apple TV + HBO Max</h3>
                          <p className="text-sm opacity-90">Kino domowe premium</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-4 rounded-xl">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-bold">Player + TVP + Polsat + Canal+</h3>
                          <p className="text-sm opacity-90">Wszystkie polskie platformy</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-yellow-800 text-sm font-medium">
                      💡 <strong>Pro tip:</strong> AeroTV Pro zapewnia stabilny sygnał DVB-T2, a Smart TV z internetem daje dostęp do streamingu. Idealne połączenie!
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Dlaczego AeroTV Pro to najbardziej zaawansowana antena na rynku?
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border-2 border-blue-200 hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Zaawansowane Przetwarzanie Sygnału</h3>
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Filtracja LTE:</strong> eliminuje zakłócenia z sieci komórkowych</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Auto-adaptacja:</strong> dostosowuje się do warunków atmosferycznych</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Stabilizacja sygnału:</strong> 99,8% uptime dzięki wzmacniaczowi</span>
                  </li>
                </ul>
                <div className="mt-4 p-3 bg-white/50 rounded-lg">
                  <p className="text-xs text-blue-700 font-medium">
                    Wynik: Krystaliczny obraz nawet w trudnych warunkach pogodowych
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-100 rounded-xl p-6 border-2 border-purple-200 hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Gotowa na 8K i Przyszłość</h3>
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>4K natywnie:</strong> HEVC H.265 zapewnia najwyższą jakość</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>8K ready:</strong> przygotowana na nadchodzące standardy</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>HDR support:</strong> szerszy zakres kolorów i kontrastów</span>
                  </li>
                </ul>
                <div className="mt-4 p-3 bg-white/50 rounded-lg">
                  <p className="text-xs text-purple-700 font-medium">
                    Inwestycja na lata — nie będziesz musiał wymieniać anteny przez dekadę!
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border-2 border-green-200 hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Uniwersalna Kompatybilność</h3>
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Smart TV:</strong> Samsung, LG, Sony, Panasonic, TCL</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Dekodery:</strong> wszystkie marki DVB-T2/HEVC</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span><strong>Stare TV:</strong> działa z konwerterami DVB-T2</span>
                  </li>
                </ul>
                <div className="mt-4 p-3 bg-white/50 rounded-lg">
                  <p className="text-xs text-green-700 font-medium">
                    Plug & Play — podłączasz i działa z każdym urządzeniem!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16 bg-gradient-to-r from-gray-50 to-white rounded-xl border-2 border-gray-200 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
                <h3 className="text-2xl font-bold text-center">AeroTV Pro vs. Standardowe Anteny</h3>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className="text-center p-4 font-semibold text-green-600">AeroTV Pro</th>
                      <th className="text-center p-4 font-semibold text-gray-500">Zwykłe anteny</th>
                    </tr>
                  </thead>
                  <tbody className="text-sm">
                    <tr className="border-b">
                      <td className="p-4 font-medium">Standard DVB-T2/HEVC</td>
                    ...
                    <tr className="border-b bg-gray-50">
                      <td className="p-4 font-medium">Wbudowany wzmacniacz</td>
                      <td className="text-center p-4"><span className="text-green-600 font-bold text-lg">✓</span></td>
                      <td className="text-center p-4"><span className="text-red-500 font-bold text-lg">✗</span></td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-4 font-medium">Filtracja LTE/5G</td>
                      <td className="text-center p-4"><span className="text-green-600 font-bold text-lg">✓</span></td>
                      <td className="text-center p-4"><span className="text-red-500 font-bold text-lg">✗</span></td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="p-4 font-medium">Gotowość na 4K/8K</td>
                      <td className="text-center p-4"><span className="text-green-600 font-bold text-lg">✓</span></td>
                      <td className="text-center p-4"><span className="text-orange-500 font-bold">Częściowo</span></td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-4 font-medium">Montaż wewnętrzny/zewnętrzny</td>
                      <td className="text-center p-4"><span className="text-green-600 font-bold text-lg">✓</span></td>
                      <td className="text-center p-4"><span className="text-orange-500 font-bold">Tylko zewnętrzny</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <section className="bg-gradient-to-br from-gray-50 to-blue-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                🏠 Kompletny System Rozrywki dla Całej Rodziny
              </h2>
              <p className="text-xl text-gray-600">
                Jedna antena, nieskończone możliwości oglądania
              </p>
            </div>
              ...
              <div>
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    ...
                    Platformy Streaming Premium
                  </h3>

                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-red-600">Netflix</div>
                      <div className="text-xs text-gray-600">Seriale + Filmy</div>
                    </div>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-blue-600">Disney+</div>
                      <div className="text-xs text-gray-600">Marvel + Star Wars</div>
                    </div>
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-purple-600">HBO Max</div>
                      <div className="text-xs text-gray-600">Premium Content</div>
                    </div>
                    <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-orange-600">Prime Video</div>
                      <div className="text-xs text-gray-600">Amazon Originals</div>
                    </div>
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-green-600">Apple TV+</div>
                      <div className="text-xs text-gray-600">Apple Originals</div>
                    </div>
                    <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3 text-center">
                      <div className="font-bold text-indigo-600">Paramount+</div>
                      <div className="text-xs text-gray-600">Movies + Sports</div>
                    </div>
                  </div>

                  <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                    <h4 className="font-bold text-blue-900 mb-2">🇵🇱 Polskie Platformy:</h4>
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">Player</span>
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">TVP VOD</span>
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">Polsat Box</span>
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">Canal+ Online</span>
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">IPLA</span>
                      <span className="bg-white px-2 py-1 rounded text-center font-medium">SkyShowtime</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-2">Kanały Naziemne DVB-T2 (BEZPŁATNE)</h3>
                        <p className="text-gray-600 text-sm mb-3">
                          Stabilny odbiór wszystkich kanałów HD i 4K bez abonamentu
                        </p>
                        <div className="flex flex-wrap gap-2">
                          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">TVP 1 HD</span>
                          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">TVP 2 HD</span>
                          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Polsat HD</span>
                          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">TVN HD</span>
                          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">+20 więcej</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-2">Smart TV + Internet = Wszystko</h3>
                        <p className="text-gray-600 text-sm mb-3">
                          Połączenie anteny z Smart TV daje dostęp do całego świata rozrywki
                        </p>
                        <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-3 rounded-lg">
                          <p className="text-purple-800 text-sm">
                            <strong>Efekt:</strong> Tradycyjna TV + wszystkie platformy VOD w jednym miejscu!
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <section className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                🔧 Specyfikacja Techniczna i Instalacja
              </h2>
              <p className="text-lg text-gray-600">
                DVB-T2/HEVC, wzmacniacz, zasięg, montaż i zgodność
              </p>
            </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center space-x-3">
                      ...
                      <span><strong>Standard:</strong> DVB-T2/HEVC (H.265)</span>
                    </li>
                    <li className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                      <span><strong>Instalacja:</strong> wewnętrzna lub zewnętrzna (uchwyt w zestawie)</span>
                    </li>
                    <li className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                      <span><strong>Wzmacniacz:</strong> wbudowany, niski poziom szumów</span>
                    </li>
                    <li className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                      <span><strong>Złącza:</strong> typowe dla tunerów/telewizorów</span>
                    </li>
                    <li className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                      <span><strong>Zasilanie:</strong> zgodnie z dołączonym modułem</span>
                    </li>
                    <li className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                      <span><strong>Zgodność:</strong> telewizory, dekodery DVB-T2, przystawki smart TV</span>
                    </li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Dlaczego AeroTV Pro?</h3>
                  <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                    <p className="text-blue-800 font-medium mb-2">
                      ✨ Idealna dla każdego domu
                    </p>
        ...
        <section className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              <FAQ
                question="Czy antena działa z DVB-T2/HEVC?"
                answer="Tak, w pełni zgodna z nowym standardem."
              />
              <FAQ
                question="Czy można używać na zewnątrz?"
                answer="Tak, konstrukcja przystosowana do montażu wewnątrz i na zewnątrz."
              />
              <FAQ
              ...
              <FAQ
                ...
                answer="Nie, to 'plug & play'. W zestawie wszystko, czego potrzebujesz."
              />
            </div>
          </div>
        </section>
              ...
              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
                ...
                <div className="flex items-center gap-3">
                  <img
                    ...
                    alt="AeroTV Pro - Antena DVB-T2/HEVC"
