...
const ThankYouPage = () => {
  ...
  useEffect(() => {
    ...
    const formatData = (data: Date): string => {
      const giorni = ['niedziela', 'poniedziałek', 'wtorek', 'środa', 'czwartek', 'piątek', 'sobota'];
  ...
  const benefits = [
    {
      ...
      title: "30-dniowa Gwarancja",
      description: "Zadowolenie lub 100% zwrot pieniędzy"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Śledzona Dostawa",
      description: "Otrzymasz SMS z numerem śledzenia"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Obsługa Klienta",
      description: "Dedykowana pomoc dla wszystkich Twoich potrzeb"
    }
  ];
  ...
  const nextSteps = [
    {
      ...
      description: "Nasz operator skontaktuje się z Tobą w ciągu najbliższych godzin, aby potwierdzić dane zamówienia",
      time: "Wkrótce"
    },
    {
      step: "2",
    ...
    },
    {
      ...
      description: "Bezpłatna dostawa z kurierem ekspresowym, numer śledzenia w paczce",
      time: "24-48 godzin"
    }
  ];
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-green-700">
                    Następny Telefon Weryfikacyjny
                  </h3>
                  <p className="text-green-600">
                    Nasz operator skontaktuje się z Tobą w ciągu najbliższych godzin
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  ...
                  Operator zweryfikuje Twoje dane i potwierdzi dostawę, aby zapewnić perfekcyjne doručenie.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            <p className="text-center text-gray-700 mb-6 text-lg">
              Zamówiono <strong>DZIŚ</strong> i dostarczone między <strong>{deliveryDates.deliveryRange}</strong>
            </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Miej włączony telefon</strong> - W najbliższych godzinach do Ciebie zadzwonimy</li>
                <li>• <strong>Sprawdź swoje dane</strong> - Operator potwierdzi Twoje imię, telefon i adres</li>
                <li>• <strong>Żadnych płatności teraz</strong> - Płacisz przy odbiorze</li>
                <li>• <strong>Bezpłatna dostawa</strong> - Bez dodatkowych kosztów</li>
                <li>• <strong>Gwarancja jest zawarta</strong> - 30 dni zadowolenia lub zwrot pieniędzy</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg mb-6">
              Podjąłeś dobrą decyzję, wybierając jakość i niezawodność naszych produktów.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Zadowolony klient</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg p-4 border-2 border-blue-200">
                ...
                <p className="text-blue-700 text-sm">Dostawa na czas</p>
              </div>

              <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg p-4 border-2 border-purple-200">
                <div className="text-2xl font-bold text-purple-600">96%</div>
                <p className="text-purple-700 text-sm">Poleciłby przyjacielowi</p>
              </div>
            </div>
          </div>
        </div>
