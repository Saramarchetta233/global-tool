...
const advancedTrackingUtils = {
  ...
  trackFacebookPurchase: async (orderData: any, clientEventId: string): Promise<void> => {
    const purchaseData = {
      ...
      content_ids: ['drone-eyesky-snap-x'],
      content_name: 'Dron EyeSky Snap X',
      value: 749.00,
      currency: 'CZK',
      num_items: 1
    };
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          currency: 'CZK',
          items: [{
            item_id: 'drone-eyesky-snap-x',
            item_name: 'Dron EyeSky Snap X',
            category: 'Drones',
            quantity: 1,
            price: 749.00
          }]
...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "30denní Záruka",
      description: "Spokojení nebo 100% vrácení peněz"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Sledovatelné Dodání",
      description: "Po SMS dostanete číslo pro sledování"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Zákaznický Servis",
      description: "Vyhrazená pomoc pro všechny vaše potřeby"
    }
  ];
  ...
  const nextSteps = [
    {
      step: "1",
      title: "Ověřovací Hovor",
      description: "Náš operátor vás bude v následujících hodinách kontaktovat pro potvrzení údajů objednávky",
      time: "Brzy"
    },
    {
      step: "2",
      title: "Příprava Objednávky",
      description: "Váš produkt pečlivě připravíme a zabalíme v našem skladu",
      time: "24 hodin"
    },
    {
      step: "3",
      title: "Expresní Dodání",
      description: "Bezplatné dodání s expresním kurýrem, číslo pro sledování v balíku",
      time: "24-48 hodin"
    }
  ];
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Děkujeme, že jste si vybrali naše produkty
          </p>
          {orderData?.orderId && (
            <p className="text-lg mt-2 opacity-80">
              Číslo Objednávky: <strong>{orderData.orderId}</strong>
            </p>
          )}
        </div>
      </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-green-700">
                    Následující Ověřovací Hovor
                  </h3>
                  <p className="text-green-600">
                    Náš operátor vás bude v následujících hodinách kontaktovat
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-green-600">📞 Mějte telefon po ruce!</strong><br />
                  Operátor ověří vaše údaje a potvrdí dodání pro zajištění perfektního doručení.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            <p className="text-center text-gray-700 mb-6 text-lg">
              Objednáno <strong>DNES</strong> a doručeno mezi <strong>{deliveryDates.deliveryRange}</strong>
            </p>
            <div className="flex justify-between items-center">
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📦</div>
                <div className="font-medium text-gray-800">Objednáno</div>
                <div className="text-gray-500 text-sm">{deliveryDates.orderDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">🚚</div>
                <div className="font-medium text-gray-800">Odesláno</div>
                <div className="text-gray-500 text-sm">{deliveryDates.shipDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📍</div>
                <div className="font-medium text-gray-800">Doručeno</div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Mějte zapnutý telefon</strong> - V následujících hodinách vám budeme volat</li>
                <li>• <strong>Zkontrolujte své údaje</strong> - Operátor potvrdí vaše jméno, telefon a adresu</li>
                <li>• <strong>Žádné platby teď</strong> - Platíte při převzetí</li>
                <li>• <strong>Bezplatné dodání</strong> - Bez dalších nákladů</li>
                <li>• <strong>Záruka je zahrnuta</strong> - 30 dní spokojenosti nebo vrácení peněz</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Připojili jste se k více než 10.000 Spokojených Zákazníků
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Učinili jste dobré rozhodnutí, když jste si vybrali kvalitu a spolehlivost našich produktů.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Spokojený zákazník</p>
              </div>
