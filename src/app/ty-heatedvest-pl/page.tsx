...
const advancedTrackingUtils = {
  ...
  trackFacebookPurchase: async (orderData: any, clientEventId: string): Promise<void> => {
    const purchaseData = {
      ...
      content_name: 'ThermoVest Pro — Kamizelka grzewcza USB 5-strefowa',
      value: 299.00,
      currency: 'PLN',
      num_items: 1
    };
...
const ThankYouPage = () => {
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twoja kamizelka grzewcza zostanie starannie przygotowana i zapakowana w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-red-50">
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <div className="animate-bounce mb-4">
            <CheckCircle className="w-20 h-20 mx-auto text-orange-100" />
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6 mb-6 border-2 border-orange-200">
              ...
              <div className="bg-white rounded-lg p-4 border border-orange-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-orange-600">📞 Miej telefon pod ręką!</strong><br />
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-gray-200">
          ...
          <div className="space-y-6">
            {nextSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-200">
                <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg">
                  {step.step}
                </div>
        ...
        {/* Benefits Reminder */}
        <div className="bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 rounded-2xl text-white p-8 mb-8">
          ...
          <div className="flex items-center justify-between mb-4 overflow-x-auto">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center min-w-0 flex-1 px-1">
                ...
                <p className={`text-xs md:text-sm mt-1 md:mt-2 font-semibold transition-all duration-500 text-center leading-tight ${index <= currentStep ? 'text-orange-600' : 'text-gray-500'
                  }`}>
                  {step}
                </p>
              </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                ...
                <li>• <strong>Darmowa wysyłka w ciągu 24/48h</strong> - Bez dodatkowych kosztów</li>
                <li>• <strong>Gwarancja w zestawie</strong> - 30 dni zadowoleni lub zwrot pieniędzy</li>
                <li>• <strong>Potwierdzenie i szczegóły</strong> zostaną wysłane na e-mail</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 2.800 Zadowolonych Klientów
            </h3>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-orange-100 to-red-100 rounded-lg p-4 border-2 border-orange-200">
                <div className="text-2xl font-bold text-orange-600">97%</div>
                <p className="text-orange-700 text-sm">Zadowolonych klientów</p>
              </div>
