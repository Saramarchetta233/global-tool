...
const advancedTrackingUtils = {
  ...
  trackPurchaseEvent: async (orderData: any): Promise<boolean> => {
    // Get eventID from localStorage for deduplication (set on landing page)
    const savedEventId = localStorage.getItem('fbEventId');
    const clientEventId = savedEventId || `purchase-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;

    console.log(`🎯 Starting Purchase tracking with eventID: ${clientEventId}`);
...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "4K Ultra HD + Stabilizacja EIS w zestawie",
      description: "Niezwykle ostre nagrania z zaawansowaną stabilizacją obrazu"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Obudowa wodoodporna do 30 m",
      description: "Idealna do nurkowania, pływania i sportów wodnych"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Pilot zdalnego sterowania nadgarstkowy",
      description: "Wygodne sterowanie bez konieczności sięgania do kamery"
    }
  ];
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twoja kamera sportowa zostanie starannie przygotowana i zapakowana wraz z zestawem akcesoriów",
      time: "24 godziny"
    },
    {
      step: "3",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <div className="animate-bounce mb-4">
            <CheckCircle className="w-20 h-20 mx-auto text-blue-100" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            🎉 Zamówienie Potwierdzone!
          </h1>
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór VoltCam™ 4K Pro
          </p>
          {orderData?.orderId && (
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-6 border-2 border-blue-200">
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-blue-600">📞 Miej telefon pod ręką!</strong><br />
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-gray-200">
          ...
          <div className="space-y-6">
            {nextSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200">
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg">
                  {step.step}
                </div>
                <div className="flex-grow">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold text-gray-800">{step.title}</h3>
                    <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm font-semibold border border-blue-300">
                      {step.time}
                    </span>
                  </div>
        ...
        {/* Benefits Reminder */}
        <div className="bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-400 rounded-2xl text-white p-8 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-gray-200">
          ...
          <div className="flex items-center justify-between mb-4 overflow-x-auto">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center min-w-0 flex-1 px-1">
                ...
                <p className={`text-xs md:text-sm mt-1 md:mt-2 font-semibold transition-all duration-500 text-center leading-tight ${index <= currentStep ? 'text-blue-600' : 'text-gray-500'
                  }`}>
                  {step}
                </p>
              </div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div
              className="bg-gradient-to-r from-blue-500 to-purple-600 h-2 rounded-full transition-all duration-500 shadow-sm"
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 12.000 Zadowolonych Klientów
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru profesjonalnej kamery sportowej z VoltCam™ 4K Pro.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg p-4 border-2 border-blue-200">
                <div className="text-2xl font-bold text-blue-600">97%</div>
                <p className="text-blue-700 text-sm">Zadowolonych klientów</p>
              </div>

              <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-lg p-4 border-2 border-purple-200">
                <div className="text-2xl font-bold text-purple-600">96%</div>
                <p className="text-purple-700 text-sm">Dostaw na czas</p>
              </div>

              <div className="bg-gradient-to-br from-indigo-100 to-blue-100 rounded-lg p-4 border-2 border-indigo-200">
                <div className="text-2xl font-bold text-indigo-600">95%</div>
                <p className="text-indigo-700 text-sm">Poleciłoby znajomemu</p>
              </div>
            </div>
          </div>
        </div>
