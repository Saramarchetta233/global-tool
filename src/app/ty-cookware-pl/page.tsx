    ...
    if (typeof window !== 'undefined' && window.gtag) {
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          currency: 'PLN',
          items: [{
            item_id: 'prosteel-12-cookware-set',
            item_name: 'ProSteel 12 — 12-częściowy zestaw garnków ze stali nierdzewnej',
            category: 'Cookware',
            quantity: 1,
            price: 349.00
          }]
...
const ThankYouPage = () => {
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twój zestaw garnków zostanie starannie przygotowany i zapakowany w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór zestawu garnków ProSteel 12
          </p>
          {orderData?.orderId && (
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 8.000 Zadowolonych Klientów
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru jakości i funkcjonalności zestawu garnków ProSteel.
            </p>
