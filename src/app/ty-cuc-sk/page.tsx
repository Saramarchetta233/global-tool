      ...
      try {
        ...
        window.gtag('event', 'purchase', {
          ...
          items: [{
            ...
            item_name: 'Kreatívny Šijací Stroj',
...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "30-dňová Záruka",
      description: "Spokojný alebo 100% vrátenie peňazí"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Sledovateľné Dodanie",
      description: "Po SMS dostanete číslo na sledovanie"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Zákaznícke Služby",
      description: "Vyhradená pomoc pre všetky vaše potreby"
    }
  ];
  ...
  const nextSteps = [
    {
      step: "1",
      title: "Overovací Hovor",
      description: "Náš operátor vás bude v nasledujúcich hodinách kontaktovať na potvrdenie údajov objednávky",
      time: "Čoskoro"
    },
    {
      step: "2",
      title: "Príprava Objednávky",
      description: "Váš produkt starostlivo pripravíme a zabalíme v našom sklade",
      time: "24 hodín"
    },
    {
      step: "3",
      title: "Express Dodanie",
      description: "Bezplatné dodanie s expresným kuriérom, číslo na sledovanie v balíku",
      time: "24-48 hodín"
    }
  ];
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Ďakujeme, že ste si vybrali naše produkty
          </p>
          {orderData?.orderId && (
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-green-700">
                    Nasledujúci Overovací Hovor
                  </h3>
                  <p className="text-green-600">
                    Náš operátor vás bude v nasledujúcich hodinách kontaktovať
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-green-600">📞 Majte telefón po ruke!</strong><br />
                  Operátor overí vaše údaje a potvrdí dodanie na zaistenie perfektného doručenia.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            <p className="text-center text-gray-700 mb-6 text-lg">
              Objednané <strong>DNES</strong> a doručené medzi <strong>{deliveryDates.deliveryRange}</strong>
            </p>
            <div className="flex justify-between items-center">
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📦</div>
                <div className="font-medium text-gray-800">Objednané</div>
                <div className="text-gray-500 text-sm">{deliveryDates.orderDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">🚚</div>
                <div className="font-medium text-gray-800">Odoslané</div>
                <div className="text-gray-500 text-sm">{deliveryDates.shipDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📍</div>
                <div className="font-medium text-gray-800">Doručené</div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Majte zapnutý telefón</strong> - V nasledujúcich hodinách vám budeme volať</li>
                <li>• <strong>Skontrolujte svoje údaje</strong> - Operátor potvrdí vaše meno, telefón a adresu</li>
                <li>• <strong>Žiadne platby teraz</strong> - Platíte pri prevzatí</li>
                <li>• <strong>Bezplatné dodanie</strong> - Bez ďalších nákladov</li>
                <li>• <strong>Záruka je zahrnutá</strong> - 30 dní spokojnosti alebo vrátenie peňazí</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Pripojili ste sa k viac než 10.000 Spokojným Zákazníkom
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Urobili ste dobré rozhodnutie, keď ste si vybrali kvalitu a spoľahlivosť našich produktov.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Spokojný zákazník</p>
              </div>
