          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Stwierdziło, że wiercenie stało się szybsze i bardziej precyzyjne!</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Zauważyło zwiększenie wydajności w swoich projektach DIY!</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Zaoszczędziło czas dzięki oświetleniu LED i funkcjom automatycznym!</p>
              </div>
            </div>
          </div>
        </div>
...
// Main Component
export default function PowerDrillLanding() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">(412 opinii)</span>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  Cena katalogowa: <span style={{ textDecoration: 'line-through', color: 'red' }}>847,99 zł</span><br />
                  <div style={{ marginTop: '10px' }}>
                    Dziś tylko: <span style={{ fontSize: '26px' }}>339,00 zł</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-bold text-gray-900 text-sm">Piotr M.</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Oświetlenie LED:</strong> Precyzyjna praca nawet w najciemniejszych miejscach dzięki wbudowanej lampce LED.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Kompletny zestaw akcesoriów:</strong> W zestawie wiertła, bity, ładowarka USB i praktyczny futerał.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Ładowanie USB:</strong> Wygodne ładowanie w domu, biurze lub w podróży z dowolnego portu USB.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Kompaktowa konstrukcja:</strong> Lekka i ergonomiczna, idealna do precyzyjnych prac i długotrwałego użytkowania.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Wiercenie Precyzyjne i Efektywne
            </h2>
            <p className="text-lg text-gray-700">
              Odkryj, jak ta wiertarka upraszcza pracę, poprawiając precyzję i wydajność w Twoich projektach DIY i profesjonalnych.
            </p>
          </div>
            ...
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">Dokładne wiercenie dzięki oświetleniu LED i stabilnej konstrukcji.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">🔋</div>
                ...
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">💡</div>
                  <h3 className="font-bold text-lg mb-2">Oświetlenie</h3>
                  <p className="text-gray-600">Wbudowana lampka LED dla pracy w ciemnych miejscach.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">⚡</div>
                  <h3 className="font-bold text-lg mb-2">Wygoda</h3>
                  <p className="text-gray-600">Ładowanie USB i kompletny zestaw akcesoriów w zestawie.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <FAQ
              ...
              answer="Zestaw zawiera kompletny set wierteł, bitów, ładowarkę USB, instrukcję obsługi i praktyczny futerał do przechowywania."
            />
            <FAQ
              question="Czy nadaje się do profesjonalnych prac?"
              answer="Tak, dzięki precyzyjnej konstrukcji, oświetleniu LED i niezawodnej baterii litowej idealnie sprawdza się w pracach profesjonalnych."
            />
            <FAQ
              question="Jak działa oświetlenie LED?"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Wypróbuj wiertarkę z całkowitym bezpieczeństwem dzięki naszej 30-dniowej gwarancji zwrotu pieniędzy. Doświadcz precyzji i wygody profesjonalnego narzędzia bez ryzyka i odkryj, jak może przekształcić Twoją pracę.
            </p>
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Tylko na dziś: <span className="line-through opacity-75">847,99 zł</span> <span className="text-5xl font-bold">339,00 zł</span>
          </p>
      ...
      {showOrderPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-lg p-6 md:p-8 max-w-md w-full relative my-4 md:my-8 min-h-0">
            ...
            <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-right flex-shrink-0">
                  <div className="font-bold text-lg md:text-xl text-gray-900">339,00 zł</div>
                  <div className="text-xs text-gray-500 line-through">847,99 zł</div>
                </div>
              </div>
            </div>
            ...
            >
              {isSubmitting ? 'PRZETWARZANIE...' : 'POTWIERDŹ ZAMÓWIENIE - 339,00 zł'}
            </button>
          </div>
        </div>
      )}
