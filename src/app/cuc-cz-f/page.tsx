    ...
    if (majorEvents.includes(eventName) || userFormData) {
      try {
        ...
        const capiData = {
          ...
          content_name: 'Kreativní Šicí Stroj',
...
const SocialProofNotification = () => {
  ...
  const notifications = [
    { name: "Marie z Prahy", action: "právě koupila", time: "před 2 min" },
    { name: "Anna z Brna", action: "přidala do košíku", time: "před 4 min" },
    { name: "Jana z Ostravy", action: "právě koupila", time: "před 6 min" },
    { name: "Eva z Plzně", action: "momentálně se dívá", time: "před 1 min" },
  ];
  ...
  return (
    <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 p-3 rounded-lg text-center font-bold">
      <div className="flex items-center justify-center space-x-2">
        ...
        <span>⚡ Na skladě je již jen {stock} kusů!</span>
      </div>
    </div>
  );
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8">
              Zmeňte svoje šitie s výjimočnými výsledkami
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Zistili ste, že šitie sa stalo jednoduchším a rýchlejším!</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Spozorovali ste rast kreativity pri vašich projektoch!</p>
              </div>
...
const DeliveryTracking = () => {
  ...
  useEffect(() => {
    const formatData = (data: Date): string => {
      const giorni = ['neděle', 'pondělí', 'úterý', 'středa', 'čtvrtek', 'pátek', 'sobota'];
      const mesi = ['led', 'úno', 'bře', 'dub', 'kvě', 'čer', 'čec', 'srp', 'zář', 'říj', 'lis', 'pro'];
    ...
    const aggiungiGiorniLavorativi = (data: Date, giorni: number): Date => {
      ...
      while (count < giorni) {
        ...
        if (giorno !== 0 && giorno !== 6) count++; // 0 = nedeľa, 6 = sobota
      }
      return nuovaData;
    };
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      <p className="text-center text-gray-700 mb-4">
        Objednejte <strong>HNED</strong> a dostanete balíček mezi <strong>{deliveryDates.deliveryRange}</strong>
      </p>
      <div className="flex justify-between items-center text-sm">
        <div className="text-center">
          <div className="text-2xl mb-1">📦</div>
          <div className="font-medium">Objednáno</div>
          <div className="text-gray-500">{deliveryDates.orderDate}</div>
        </div>
        <div className="text-center">
          <div className="text-2xl mb-1">🚚</div>
          <div className="font-medium">Odesláné</div>
          <div className="text-gray-500">{deliveryDates.shipDate}</div>
        </div>
        <div className="text-center">
          <div className="text-2xl mb-1">📍</div>
          <div className="font-medium">Doručeno</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Nejkvalitnější šicí stroje pro vaši kreativitu.
            </p>
          </div>

          <div>
            <h4 className="font-semibold mb-4">Služby pre zákazníkov</h4>
            <ul className="space-y-2 text-sm text-gray-300">
              <li><a href="/contact" target="_blank" rel="noopener noreferrer" className="hover:text-white">Kontakt</a></li>
              <li><a href="#" className="hover:text-white">Často kladené otázky</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          ...
          <div className="mt-6 text-xs text-gray-500 max-w-4xl mx-auto">
            <p className="mb-2">
              <strong>Právne informácie:</strong> Všetky ceny zahrňajú DPH. Právo na odstúpenie od zmluvy do 14 dní v súlade so zákonodárstvom o ochrane spotrebiteľov.
              24-mesečná záruka v súlade s Občianskym zákonníkom. Predávajúci: Newheras s.r.o.
            </p>
            <p>
              <strong>Ochrana údajov:</strong> Vaše osobné údaje spracúvame v súlade s GDPR. Podrobnosti v Pravidlách ochrany súkromia.
              Používame cookies na analytické a marketingové účely. Viac informácií v Pravidlách o cookies.
            </p>
          </div>
        </div>
      </div>
...
export default function SewingMachineLanding() {
  ...
  useEffect(() => {
    ...
    trackingUtils.trackGoogleEvent('page_view', {
      page_title: 'Kreativní Šicí Stroj - Hlavní stránka',
  ...
  const handleOrderClick = () => {
    ...
    trackingUtils.trackGoogleEvent('view_item', {
      ...
      items: [{
        ...
        item_name: 'Kreativní Šicí Stroj',
  ...
  const validateForm = () => {
    ...
    if (!formData.imie.trim()) {
      errors.imie = 'Jméno a příjmení jsou povinné';
      isValid = false;
    ...
    if (!formData.telefon.trim()) {
      ...
      if (!phoneRegex.test(formData.telefon.trim())) {
        errors.telefon = 'Prosím, zadejte platné telefonní číslo';
        isValid = false;
      }
    }
    ...
    if (!formData.adres.trim()) {
      ...
      errors.adres = 'Adresa musí být podrobnější (ulice, číslo domu, město, poštovní směrovací číslo)';
      isValid = false;
    }
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      apiFormData.append('offer', '235');
      apiFormData.append('lp', '235');
      ...
      if (response.ok) {
        ...
        window.location.href = '/ty-cuc-cz';
      } else {
        console.error('API Error:', response.status, response.statusText);
        alert('Pri odesíalianí objednávky došlo k chybe. Prosím, skúsite to znovu neskôr.');
      }
    } catch (error) {
      console.error('Network Error:', error);
      alert('Došlo k chybe pri pripojení. Skontrolujte internetové pripojenie a skúsite znovu.');
    } finally {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4">
        <div className="flex items-center justify-center space-x-4 text-sm font-medium">
          <span>🔥 OMEZENÁ NABÍDKA - Pouze dnes za speciální cenu!</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1">
              <div className="relative">
                <img
                  src="/images/cuc-cz/Cuc_pl20.png"
                  alt="Kreativní Šicí Stroj"
                  className="w-full h-auto rounded-lg shadow-lg"
                />
            ...
            <div className="order-2 space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">(347 hodnotenia)</span>
              </div>

              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                🧵 Kreativní Šicí Stroj
              </h1>

              <p className="text-lg text-gray-700 font-medium">
                <strong>Usnadňuje šití s automatickými funkcemi a přesnými výsledky pro kreativní projekty.</strong>
              </p>

              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🎯 <strong>Zvyšuje přesnost</strong> – Složité švy bez chyb</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">⏱️ <strong>Ušetří čas</strong> – Automatické navějení niti v okamžiku</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🤝 <strong>Stálá podpora</strong> – Pomoc je vždy k dispozici</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <h2 style={{
                  ...
                  🧵 Kreativní Šicí Stroj – Kompatibilní, Výkonný, Velmi Jednoduchý na Používání
                </h2>
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>📅 Široký výběr švů: 165 programů v balíčku (ozdobné, užitečné a alfanumerické)</span>
                  <span style={{
                    color: 'red',
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>✨ Automatické navlékání niti: Ušetří čas a stres</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>🔢 Osvětlený LCD displej: Vše pod kontrolou</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>🛋 Kompletn\u00ed v\u00fdbava: Rozkladac\u00ed st\u016fl, p\u00e1tky, DVD a je\u0161t\u011b mnoho dal\u0161\u00edho</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  🚚 <strong>Bezplatná doprava</strong> po celé České republice (dodání 3-4 pracovní dny)
                </div>
                ...
                <div style={{
                  ...
                  💶 <strong>Platba při převzetí</strong> k dispozici
                </div>
                ...
                <div style={{
                  ...
                  Katalogová cena: <span style={{ textDecoration: 'line-through', color: 'red' }}>4.372,50 Kč</span><br />
                  <div style={{ marginTop: '10px' }}>
                    Dnes pouze: <span style={{ fontSize: '26px' }}>1.749,00 Kč</span>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  ⏳ <strong>Nabídka platí jen několik dní!</strong><br />
                  Využijte ji dříve, než se cena vrátí na plnou hodnotu.
                </div>
                ...
                <div style={{
                  ...
                  ⚡ Poslední kusy k dispozici na skladě
                </div>

                <p style={{ textAlign: 'center', fontSize: '14px', color: '#555' }}>
                  📦 Dodání do 24/48 hodin – Dodání zaručené do 3-4 dní
                </p>
              </div>
              ...
              >
                🔥 OBJEDNEJTE HNED - Platba při převzetí
              </button>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 text-sm leading-relaxed mb-3">
                      "Před 3 týdny jsem si koupila tento stroj a jsem nadšená! 🌟 Automatické navlékání niti je skutečný průlom - ušetří tolik času! Už jsem šila několik oděvů a polštářů. Kvalita švů je neuvěřitelná, ovládání LCD je velmi intuitivní. Nejlepší nákup roku!"
                    </p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-bold text-gray-900 text-sm">Marie K. - Praha</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                ✨ Objevte Kreativní Šicí Stroj – Dokonalého Partnera pro Všechny Projekty!
              </h2>
              <p className="text-lg text-gray-700 mb-6">
                <strong>Kreativní Šicí Stroj</strong> je navržen tak, aby oslobodil vaši kreativitu a zjednodušil každý krok šití.
              </p>
              <p className="text-lg text-gray-700">
                S <strong>165 vestavenými švy</strong>, včetně užitečných, ozdobných a alfanumerických švů, můžete realizovat jakýkoli projekt, od oblečení po domací vybavení.
              </p>
            </div>
            <div>
              <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <img
                src="/images/cuc-cz/Cuc_pl19.png"
                alt="Cechy maszyny"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-lg">
                    <strong>Široký výber švov:</strong> 165 vstavaných švov, vrátane 110 užitočných a ozdobných švov, 8 automatických štýlov pre gombíkové dierky a 55 alfanumerických znakov.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Automatické navliekanie níte:</strong> Ušetrí čas a námahu s automatickým systémom pre navliekanie níte.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Intuitívny LCD displej:</strong> Jednoduchý výber švov a nastavenie na osvetlenom displeji.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Príslaušnstvo v balíčku:</strong> Dodanie s tvrdým ochranným krytom, rozkladacím stolom, 8 šijacími a quilt pätkami, učebným DVD a še veľa viac.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Venovano podpora:</strong> Bezplatná technická pomoc online, v chate alebo telefonicky počas celého života stroja.
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700">
              Objavte, ako tento stroj zjednoduší šitie, zlepší presnosť a kreatívitu pri vašich projektoch.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <img
                src="/images/cuc-cz/Cuc_pl18.png"
            ...
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">Jednoduché dosáhnutie presných a rovnomerných švov.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">🧵</div>
                  <h3 className="font-bold text-lg mb-2">Všestrannosť</h3>
                  <p className="text-gray-600">Výber medzi početnými ozdobnými a užitočnými švami.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">🕒</div>
                  <h3 className="font-bold text-lg mb-2">Ušetrenie času</h3>
                  <p className="text-gray-600">Automatické navliekanie níte pre okamžitý začiatok.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4">📚</div>
                  <h3 className="font-bold text-lg mb-2">Podpora</h3>
                  <p className="text-gray-600">Technická pomoc celodon pre váš pokoj.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700">
              Na rozdiel od iných ponúka automatické funkcie, široký stôl a celodon technickú podporu, čo zlepšuje skúsenost šitia a kreatívitu.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <FAQ
              question="Jak usnadňuje automatické šití?"
              answer="Stroj má automatický výběr švů a navlékání niti pro jednoduché a rychlé šití."
            />
            <FAQ
              question="Jaké příslušenství je zahrnuto v balíčku?"
              answer="Obsahuje široký stůl, tvrdý kryt, šicí pátky a učební DVD."
            />
            <FAQ
              question="Je vhodný pro quilting projekty?"
              answer="Ano, díky širokému stolu a ozdobným švům je ideální pro veliké quilting projekty."
            />
            <FAQ
              question="Jak funguje technická podpora?"
              answer="Nabízime online a telefonickou podporu po celou životnost produktu, což zaručuje nepřetržitou pomoc."
            />
            <FAQ
              question="Je stroj jednoduchý na používání pro začátečníky?"
              answer="Absolutně ano, s intuitivními funkcemi a LCD displejem je ideální i pro začátečníky."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Názory zákazníkov o šijacom stroji
            </h2>
            <p className="text-lg text-gray-700">
              Autentické a spoahlivé názory
            </p>
          </div>
            ...
            {[
              {
                name: "Anna M. - Praha",
                rating: 5,
                review: "Tento šicí stroj změnil můj způsob šití! 😍 Výběr švů je perfektní a umožňuje mi tvořit umělecká díla. Miluji jeho jednoduchou obsluhu, technická podpora je vždy k dispozici."
              },
              {
                name: "Kateřina R. - Brno",
                rating: 4,
                review: "Jednoduchý na používání, ačkoli některé funkce vyžadují cvičení. Celkově jsem s nákupem velmi spokojená."
              },
              {
                name: "Marie S. - Ostrava",
                rating: 5,
                review: "Perfektní pro šití! Nemůžu uvěřit, jak jednoduché je šít oblečení s tímto strojem!"
              },
              {
                name: "Judita F. - Plzeň",
                rating: 4,
                review: "Funkce tohoto stroje mi umožnily objevit nové obzory při šití. Vrčle doporučuji!"
              },
              {
                name: "Eva J. - Liberec",
                rating: 5,
                review: "Stroj je fantastický, ale služby pro zákazníky jsou ještě lepší. Pomohli mi se všemi otázkami."
              },
              {
                name: "Zuzana O. - Olomouc",
                rating: 5,
                review: "Perfektní nákup pro ty, kteří hledají všestrannost a kvalitu. Výběr švů je perfektní pro všechny kreativní projekty!"
              },
              {
                name: "Barbora N. - Pardubice",
                rating: 4,
                review: "Skutečně užitečný! Šila jsem záclony, oblečení, dokonce obrovský polštář! Široký stůl je nezbytný."
              },
              {
                name: "Lucie P. - Hradec Králové",
                rating: 5,
                review: "Nemůžu žít bez funkce automatického navějení niti, skutečně ušetří život!"
              },
              {
                name: "Barbora H. - České Budějovice",
                rating: 5,
                review: "Ideální pro ty, kteří rádi šijí a vytvářejí jedinečná umělecká díla. I po týdnech intenzivního používání stále perfektně funguje."
              }
            ].map((review, index) => (
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <StarRating rating={5} />
                  <span className="font-medium">Ana K. - Praha</span>
                  <span className="text-sm text-gray-600">Preverjeni kupec</span>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              30-dňová záruka vrátenia peníz
            </h2>
            <p className="text-lg text-gray-700 mb-6">
              Vyskúšajte šijací stroj úplne bezpečne s našou 30-dňovou zárukou vrátenia peníz. Za\u017eite jednoduchosth a presnosth \u0161itia bez rizika a objavte, ako môžete zmeniť svoju kreatívitu.
            </p>
            <p className="text-xl font-bold text-green-600">
              Ak nie ste úplne spokojní, vrátime celú sumu.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Platba priamo pri prevzatí</span>
              </div>
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Pomoc 24 hodín denne, 7 dní v týždni</span>
              </div>
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-bold text-lg mb-4">DODÁVÁNÍ</h3>
              <p className="text-gray-700 mb-4">
                Dodáváme po celé České republice, a pokud je objednávka zadaná před 21:59, pošleme ji následující pracovní den.
              </p>
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <Check className="w-4 h-4 text-green-600" />
                  <span className="text-sm">Doručeno za 3-4 pracovní dny</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Check className="w-4 h-4 text-green-600" />
              ...
              <p className="text-sm text-gray-600 mt-4">
                Výhradní prodej <strong>NEWHERAS</strong>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">
            🔥 Nemenajte túto špeciálnu ponuku!
          </h2>
          <p className="text-xl mb-8">
            Pouze dnes: <span className="line-through opacity-75">4.372,50 Kč</span> <span className="text-5xl font-bold">1.749,00 Kč</span>
          </p>
          ...
          <div className="bg-white/10 backdrop-blur rounded-lg p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Stupeň spokojnosti</div>
              </div>
              <div>
                <Clock className="w-8 h-8 mx-auto mb-2" />
                <div className="font-bold">24/7</div>
                <div className="text-sm opacity-90">Služby pre zákazníkov</div>
              </div>
            </div>
          </div>
          ...
          <p className="text-sm opacity-90">
            ⚡ Časovo omedzená ponuka • 🚚 Bezplatná doprava • 💯 30-dňová záruka
          </p>
        </div>
      </section>
      ...
      {showOrderPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-lg p-6 md:p-8 max-w-md w-full relative my-4 md:my-8 min-h-0">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2 pr-8">Vyplňte pro objednávku</h3>
            <p className="text-gray-600 mb-4 md:mb-6">Platba při převzetí</p>
            ...
            <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs md:text-sm text-green-600">✅ Bezplatná doprava</div>
                </div>
                <div className="text-right flex-shrink-0">
                  <div className="font-bold text-lg md:text-xl text-gray-900">1.749,00 Kč</div>
                  <div className="text-xs text-gray-500 line-through">4.372,50 Kč</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4 md:mb-6">
              <div className="text-center">
                ...
                <div className="text-xs text-red-600 mt-1">
                  Zbývající čas na potvrzení objednávky
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Kompletní adresa *</label>
                <textarea
                  ...
                  placeholder="Ulice, číslo domu, město, poštovní směrovací číslo"
                />
                {formErrors.adres && (
            ...
            <div className="flex items-center justify-center gap-2 mb-4 mt-4 text-gray-700">
              ...
              <span className="font-medium text-sm md:text-base">Platba při převzetí</span>
            </div>
            ...
            >
              {isSubmitting ? 'ZPRACOV\u00c1V\u00c1...' : 'POTVRDIT OBJEDNÁVKU - 1.749,00 Kč'}
            </button>
          </div>
        </div>
      )}
