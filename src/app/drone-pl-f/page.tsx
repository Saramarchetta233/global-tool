...
const trackingUtils = {
  ...
  initGoogleAds: () => {
    if (typeof window !== 'undefined') {
      ...
      window.gtag('config', 'AW-17740732466');

      // Load gtag script
      const script = document.createElement('script');
      script.async = true;
      script.src = 'https://www.googletagmanager.com/gtag/js?id=AW-17740732466';
    ...
    if (majorEvents.includes(eventName) || userFormData) {
      try {
        ...
        const capiData = {
          ...
          content_name: 'Dron EyeSky Snap X z Kamerą HD',
...
const SocialProofNotification = () => {
  ...
  const notifications = [
    ...
    { name: "Julia z Krakowa", action: "dodała do koszyka", time: "4 minuty temu" },
    { name: "Marek z Gdańska", action: "właśnie kupił", time: "6 minut temu" },
    { name: "Zofia z Wrocławia", action: "ogląda teraz", time: "1 minutę temu" },
  ];
  ...
  return (
    <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 p-3 rounded-lg text-center font-bold">
      <div className="flex items-center justify-center space-x-2">
        ...
        <span>⚡ Tylko {stock} sztuk zostało w magazynie!</span>
      </div>
    </div>
  );
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <img
              ...
              alt="Dron EyeSky Snap X w locie z profesjonalnymi rezultatami"
              className="w-full h-auto rounded-lg shadow-lg"
            />
          </div>
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8">
              Przemień Swoją Pasję do Fotografii Powietrznej
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Poprawiło swoje umiejętności filmowania z powietrza!</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Stworzyło bardziej kreatywne i angażujące treści!</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">Zaoszczędziło czas dzięki automatycznym funkcjom!</p>
              </div>
            </div>
          </div>
        </div>
...
const DeliveryTracking = () => {
  ...
  useEffect(() => {
    const formatData = (data: Date): string => {
      const giorni = ['ndz', 'pon', 'wt', 'śr', 'czw', 'pt', 'sob'];
    ...
    setDeliveryDates({
      ...
      deliveryRange: `${formatData(dataConsegnaInizio)} do ${formatData(dataConsegnaFine)}`
    });
  }, []);
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      <p className="text-center text-gray-700 mb-4">
        Zamów <strong>TERAZ</strong> a otrzymasz swoją paczkę między <strong>{deliveryDates.deliveryRange}</strong>
      </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Drony wysokiej jakości dla Twojej powietrznej kreatywności.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-semibold mb-4">Działalność komercyjna</h4>
            <ul className="space-y-2 text-sm text-gray-300">
              <li><a href="/about" target="_blank" rel="noopener noreferrer" className="hover:text-white">O nas</a></li>
              <li><a href="#" className="hover:text-white">Nasza historia</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          ...
          <div className="mt-6 text-xs text-gray-500 max-w-4xl mx-auto">
            <p className="mb-2">
              <strong>Informacje prawne:</strong> Wszystkie ceny zawierają VAT. Prawo do odstąpienia od umowy w ciągu 14 dni zgodnie z przepisami konsumenckimi.
...
export default function DroneLanding() {
  ...
  useEffect(() => {
    ...
    trackingUtils.trackGoogleEvent('page_view', {
      page_title: 'Dron EyeSky Snap X z Kamerą HD - Strona Główna',
  ...
  const handleOrderClick = () => {
    ...
    trackingUtils.trackGoogleEvent('view_item', {
      ...
      items: [{
        ...
        item_name: 'Dron EyeSky Snap X z Kamerą HD',
        category: 'Drones',
        quantity: 1,
        price: 299.00
      }]
  ...
  const validateForm = () => {
    ...
    if (!formData.imie.trim()) {
      errors.imie = 'Imię i nazwisko są wymagane';
      isValid = false;
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      apiFormData.append('offer', '46');
      apiFormData.append('lp', '46');
      ...
      if (response.ok) {
        ...
        const orderData = {
          ...formData,
          orderId,
          product: 'Dron EyeSky Snap X z Kamerą HD',
          price: 299.00,
        ...
        window.location.href = '/ty-drone-pl';
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1">
              <div className="relative">
                <img
                  ...
                  alt="Dron EyeSky Snap X z Kamerą 4K"
                  className="w-full h-auto rounded-lg shadow-lg"
                />
            ...
            <div className="order-2 space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">(1.254 opinii)</span>
              </div>

              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
                🚁 Dron EyeSky Snap X - Kamera HD 4K Ultra
              </h1>

              <p className="text-lg text-gray-700 font-medium">
                <strong>Najbardziej zaawansowany dron do spektakularnych nagrań z powietrza: kamera 4K ze stabilizacją, inteligentne sterowanie zdalne i autonomiczny lot do uchwycenia niezapomnianych momentów.</strong>
              </p>

              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">📹 <strong>Kamera 4K Ultra HD</strong> – Profesjonalne filmy i zdjęcia z góry</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🔄 <strong>Stabilizacja Gimbal</strong> – Płynne filmy bez wibracji</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">🛫 <strong>90 Minut Lotu</strong> – 2 Potężne baterie na długie sesje powietrzne</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                  <span className="text-base">📱 <strong>App Smart Control</strong> – Zaawansowane sterowanie przez smartfon</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <h2 style={{
                  ...
                  🚁 Dron EyeSky Snap X - Kamera 4K Ultra HD - Kompaktowy i Profesjonalny
                </h2>
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>📹 Kamera 4K Ultra HD: Zdjęcia i filmy w wysokiej rozdzielczości z zaawansowaną stabilizacją</span>
                  <span style={{
                    color: 'red',
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>✨ Sterowanie gestami i głosem: Intuicyjne pilotowanie prostymi komendami</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>📱 Inteligentna aplikacja GPS: Tryb follow-me i automatyczny powrót do bazy</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  <span style={{ flex: '1 1 70%' }}>🎮 Kompletny zestaw akcesoriów: Profesjonalna walizka, dodatkowe baterie, śmigła zapasowe</span>
                  <span style={{
                    color: '#16a34a',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap'
                ...
                <div style={{
                  ...
                  🚚 <strong>Darmowa wysyłka</strong> w całej Polsce (dostawa w 3-4 dni robocze)
                </div>
                ...
                <div style={{
                  ...
                  Cena katalogowa: <span style={{ textDecoration: 'line-through', color: 'red' }}>598,00 zł</span><br />
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 text-sm leading-relaxed mb-3">
                      "Kupiłem ten dron 3 tygodnie temu i jestem zachwycony! 🌟 Stabilizacja jest niesamowita - koniec z drżącymi filmami! Nagrałem już kilka filmów na Instagram i YouTube. Jakość 4K jest kinowa a aplikacja sterująca bardzo intuicyjna. Najlepszy zakup roku!"
                    </p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-bold text-gray-900 text-sm">Marek K.</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                ✨ Dron EyeSky Snap X – Zaawansowana Technologia do Spektakularnych Nagrań Powietrznych!
              </h2>
              <p className="text-lg text-gray-700 mb-6">
                <strong>Dron EyeSky Snap X</strong> łączy najnowocześniejszą technologię z prostotą obsługi, oferując niepowtarzalne doświadczenie lotu i nagrania w jakości profesjonalnej.
              </p>
              <p className="text-lg text-gray-700">
                Wyposażony w <strong>kamerę 4K Ultra HD ze stabilizacją</strong> i inteligentne systemy sterowania, jest idealny do uchwycenia wyjątkowych momentów, tworzenia treści społecznościowych i realizacji zapierających dech w piersiach filmów.
              </p>
            </div>
            <div>
              <img
                src="/images/drone/drone_gif.gif"
                alt="Dron EyeSky Snap X w akcji podczas nagrywania"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <img
                ...
                alt="Zaawansowane funkcje Drona EyeSky Snap X"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-lg">
                    <strong>Kamera 4K Ultra HD:</strong> Nagrywa filmy i zdjęcia w rozdzielczości Ultra HD 4K z krystalicznie czystymi detalami, idealna dla twórców treści i miłośników fotografii powietrznej.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Zaawansowana Stabilizacja:</strong> Elektroniczny system gimbal zapewniający płynne i stabilne nagrania, eliminując wibracje i oscylacje podczas lotu.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>App Smart Control:</strong> Pełne sterowanie przez smartfon z zintegrowanym GPS, trybem follow-me, nawigacją waypoint i automatycznym powrotem.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Kompletny Zestaw Akcesoriów:</strong> Wytrzymała walizka transportowa, 2 baterie ładowalne, zestaw śmigieł zapasowych, ładowarka USB i ilustrowany podręcznik użytkownika.
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                  <div className="text-lg">
                    <strong>Kompleksowa Obsługa:</strong> Bezpłatna pomoc techniczna przez czat, e-mail i telefon, plus samouczki wideo online do nauki zaawansowanych technik lotu.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Intuicyjny Lot i Profesjonalne Rezultaty
            </h2>
            <p className="text-lg text-gray-700">
              Odkryj jak Dron EyeSky Snap X przekształca Twoje kreatywne pomysły w spektakularne nagrania powietrzne z najnowocześniejszą technologią i uproszczonymi sterownikami.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <img
                ...
                alt="Dron EyeSky Snap X podczas lotu"
                className="w-full h-auto rounded-lg shadow-lg"
              />
            </div>
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">Zaawansowany GPS dla precyzyjnych lotów i płynnych manewrów.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">Wiele trybów lotu dla początkujących i doświadczonych.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  <div className="text-4xl mb-4 bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">🕒</div>
                  <h3 className="font-bold text-lg mb-2">Łatwy Setup</h3>
                  <p className="text-gray-600">Gotowy do lotu w mniej niż 2 minuty od włączenia.</p>
                </div>
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">Dedykowana pomoc techniczna i społeczność online.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Dlaczego Dron EyeSky Snap X Jest Lepszy od Konkurencji
            </h2>
            <p className="text-lg text-gray-700">
              W przeciwieństwie do innych dronów, oferuje profesjonalną technologię 4K, inteligentne sterowanie i kompleksowe wsparcie, gwarantując doskonałe doświadczenie lotu i wyjątkowe rezultaty.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 sm:p-8 overflow-x-auto">
            <div className="min-w-full">
              <div className="hidden md:grid md:grid-cols-3 gap-4 text-center mb-4">
                <div></div>
                <div className="font-bold text-lg">Dron EyeSky Snap X</div>
                <div className="font-bold text-lg">Inne Drony</div>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Często Zadawane Pytania o Dronie EyeSky Snap X
            </h2>
            <p className="text-lg text-gray-700">
              Wszystkie odpowiedzi, których szukasz dla bezpiecznego i świadomego zakupu.
            </p>
          </div>

          <div className="space-y-4">
            <FAQ
              question="Jak łatwy jest do pilotowania dla początkującego?"
              answer="Dron EyeSky Snap X jest wyposażony w tryb początkującego z uproszczonymi sterownikami, automatyczną stabilizacją i funkcjami bezpieczeństwa, które sprawiają, że lot jest intuicyjny nawet dla osób zaczynających."
            />
            <FAQ
              question="Co zawiera kompletny zestaw?"
              answer="Zestaw zawiera: dron EyeSky Snap X, pilot zdalnego sterowania, 2 baterie ładowalne, ładowarkę USB, zestaw śmigieł zapasowych, walizkę transportową i ilustrowany podręcznik użytkownika."
            />
            <FAQ
              question="Jaką autonomię ma bateria?"
              answer="Każda bateria zapewnia do 45 minut ciągłego lotu. Z 2 dołączonymi bateriami możesz latać przez łącznie 90 minut, idealnie na długie sesje nagrywania."
            />
            <FAQ
              question="Jak działa pomoc techniczna?"
              answer="Oferujemy bezpłatną pomoc techniczną przez e-mail, czat i telefon, plus bibliotekę samouczków wideo online i dedykowaną społeczność do dzielenia się radami i trikami lotniczymi."
            />
            <FAQ
              question="Czy dron jest odporny na wiatr?"
              answer="Tak, zaawansowany system stabilizacji i potężne silniki pozwalają na stabilne loty nawet przy umiarkowanym wietrze do 25 km/h, zapewniając płynne nagrania w różnych warunkach."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Zweryfikowane Opinie Naszych Klientów
            </h2>
            <p className="text-lg text-gray-700">
              Autentyczne opinie osób, które już wybrały Dron EyeSky Snap X
            </p>
          </div>
            ...
            {[
              {
                name: "Marek K.",
                rating: 5,
                review: "Ten dron zmienił moją pasję do fotografii! 🚁 Jakość wideo 4K jest niesamowita a sterowanie tak intuicyjne. Idealny na moje podróże i nagrania społecznościowe!"
              },
              {
                name: "Julia T.",
                rating: 4,
                review: "Łatwy w obsłudze nawet dla początkujących. Tryb początkującego jest idealny do nauki bez stresu. Doskonały stosunek jakości do ceny!"
              },
              {
                name: "Aleksander M.",
                rating: 5,
                review: "Niesamowita stabilność lotu! Nagrałem profesjonalne filmy na mój kanał YouTube. Bateria rzeczywiście wytrzymuje 45 minut na sesję."
              },
              {
                name: "Zofia B.",
                rating: 4,
                review: "Funkcje GPS i follow-me są fantastyczne do filmów sportowych. Gorąco polecam ten dron!"
              },
              {
                name: "Łukasz W.",
                rating: 5,
                review: "Fantastyczny dron, ale obsługa klienta jest jeszcze lepsza. Pomogli mi z każdym pytaniem i wątpliwością."
              },
              {
                name: "Franciszka D.",
                rating: 5,
                review: "Idealny zakup dla twórców treści! Jakość nagrań powietrznych jest kinowa, idealna do każdego kreatywnego projektu!"
              },
              {
                name: "Dawid S.",
                rating: 4,
                review: "Naprawdę przydatny na moich wędrówkach! Nagrałem zapierające dech w piersiach krajobrazy, których nigdy wcześniej nie mogłem uchwycić. Walizka jest bardzo praktyczna."
              },
              {
                name: "Klara L.",
                rating: 5,
                review: "Nie mogę się już bez niego obejść! Funkcja automatycznego powrotu uratowała mnie wielokrotnie, gdy traciłam orientację."
              },
              {
                name: "Andrzej P.",
                rating: 5,
                review: "Idealny dla tych, którzy kochają uchwycać wyjątkowe momenty z góry. Po miesiącach intensywnego użytkowania nadal działa perfekcyjnie, jakość na najwyższym poziomie!"
              }
            ].map((review, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center space-x-2 mb-3">
                  <StarRating rating={review.rating} />
                  <span className="text-sm text-gray-600">Zakup Zweryfikowany</span>
                </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700">
                  "Ten dron całkowicie zmienił moją pasję do fotografii! 🚁 Jakość wideo 4K jest po prostu niesamowita i uchwytuje detale, których nigdy sobie nie wyobrażałem. Sterowanie jest tak intuicyjne, że nawet moja żona potrafiła go pilotować za pierwszym razem. Obsługa klienta jest zawsze dostępna i kompetentna. Nie mógłbym być bardziej zadowolony z mojego zakupu!"
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Gwarancja Satysfakcji lub Zwrot Pieniędzy w 30 Dni
            </h2>
            <p className="text-lg text-gray-700 mb-6">
              Wypróbuj Dron EyeSky Snap X w pełnym bezpieczeństwie z naszą 30-dniową gwarancją zwrotu pieniędzy. Doświadcz jakości nagrań powietrznych bez ryzyka i odkryj, jak może przekształcić Twoją kreatywność.
            </p>
            <p className="text-xl font-bold text-green-600">
              Jeśli nie jesteś całkowicie zadowolony, zwracamy całą kwotę.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Kod śledzenia dla każdego zamówienia</span>
              </div>
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Płatność bezpośrednio przy odbiorze</span>
              </div>
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Obsługa 24 godziny na dobę, 7 dni w tygodniu</span>
              </div>
              <div className="flex items-start space-x-3">
                <Check className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Żadnych ukrytych kosztów!</span>
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-bold text-lg mb-4">WYSYŁKA</h3>
              <p className="text-gray-700 mb-4">
                Wysyłamy w całej Polsce i jeśli zamówienie zostanie złożone przed 21:59, zostanie wysłane następnego dnia roboczego.
              </p>
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <Check className="w-4 h-4 text-green-600" />
                  <span className="text-sm">Kod śledzenia wliczony</span>
                </div>
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-slate-800 via-blue-900 to-slate-800 text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Tylko dziś: <span className="line-through opacity-75 text-red-500">598,00 zł</span> <span className="text-5xl font-bold text-green-500">299,00 zł</span>
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8 border border-white/20 shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Wskaźnik Satysfakcji</div>
              </div>
              <div>
                <Clock className="w-8 h-8 mx-auto mb-2" />
                <div className="font-bold">24/7</div>
                <div className="text-sm opacity-90">Obsługa Klienta</div>
              </div>
            </div>
          </div>
          ...
          <p className="text-sm opacity-90">
            ⚡ Oferta limitowana w czasie • 🚚 Darmowa wysyłka • 💯 Gwarancja 30 dni
          </p>
        </div>
      </section>
          ...
          <div className="bg-white rounded-lg p-6 md:p-8 max-w-md w-full relative my-4 md:my-8 min-h-0">
            ...
            <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                <img
                  src="/images/drone/img_princ.png"
                  alt="Dron EyeSky Snap X"
                  className="w-12 h-12 md:w-16 md:h-16 rounded-lg border border-gray-200 object-cover flex-shrink-0"
                />
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-gray-900 text-sm md:text-base">Dron EyeSky Snap X z Kamerą 4K</div>
                  <div className="text-xs md:text-sm text-gray-600">Kompaktowy, Potężny, Bardzo Łatwy w Użyciu</div>
                  <div className="text-xs md:text-sm text-green-600">✅ Darmowa wysyłka</div>
                </div>
                <div className="text-right flex-shrink-0">
                  <div className="font-bold text-lg md:text-xl text-green-600">299,00 zł</div>
                  <div className="text-xs text-red-500 line-through">598,00 zł</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4 md:mb-6">
              <div className="text-center">
                ...
                <div className="text-xs text-red-600 mt-1">
                  Pozostały czas na zakończenie zamówienia
                </div>
              </div>
            </div>
