...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      description: "Elégedett vagy vagy 100% pénzvisszatérítés"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Követhető Szállítás",
      description: "SMS-ben megkapja a követési számot"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Ügyfélszolgálat",
      description: "Dedikált segítség minden szükségéhez"
    }
  ];
  ...
  const nextSteps = [
    {
      step: "1",
      title: "Ellenőrző Hívás",
      description: "Operátorünk a következő órákban felveszi Önnel a kapcsolatot a rendelési adatok megerősítéséért",
      time: "Hamarosan"
    },
    {
      step: "2",
      title: "Rendelés Előkészítése",
      description: "Termékét gondosan előkészítjük és becsomagoljuk raktárunkban",
      time: "24 óra"
    },
    {
      step: "3",
      title: "Expressz Szállítás",
      description: "Ingyenes szállítás expressz futárral, követési számmal a csomagban",
      time: "24-48 óra"
    }
  ];
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          {orderData?.orderId && (
            <p className="text-lg mt-2 opacity-80">
              Rendelési Szám: <strong>{orderData.orderId}</strong>
            </p>
          )}
        </div>
      </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-green-700">
                    Következő Ellenőrző Hívás
                  </h3>
                  <p className="text-green-600">
                    Operátorünk a következő órákban felveszi Önnel a kapcsolatot
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-green-600">📞 Tartsa kéznél a telefont!</strong><br />
                  Az operátor ellenőrzi adatait és megerősíti a szállítást a tökéletes kézbesítés garntálásáért.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            <p className="text-center text-gray-700 mb-6 text-lg">
              Megrendelve <strong>MA</strong> és kézbesítve <strong>{deliveryDates.deliveryRange}</strong> között
            </p>
            <div className="flex justify-between items-center">
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📦</div>
                <div className="font-medium text-gray-800">Megrendelve</div>
                <div className="text-gray-500 text-sm">{deliveryDates.orderDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">🚚</div>
                <div className="font-medium text-gray-800">Elküldve</div>
                <div className="text-gray-500 text-sm">{deliveryDates.shipDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📍</div>
                <div className="font-medium text-gray-800">Kézbesítve</div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Tartsa bekapcsolva a telefont</strong> - A következő órákban hívni fogjuk</li>
                <li>• <strong>Ellenőrizze adatait</strong> - Az operátor megerősíti nevét, telefonszámát és címét</li>
                <li>• <strong>Nincs fizetés most</strong> - Átvételkor fizet</li>
                <li>• <strong>Ingyenes szállítás</strong> - Plusz költségek nélkül</li>
                <li>• <strong>Garancia jár hozzá</strong> - 30 nap elégedettség vagy pénzvisszatérítés</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Csatlakozott Több Mint 10.000 Elégedett Ügyfélhez
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Jó döntést hozott termékeink minőségét és megbízhatóságát választva.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Elégedett ügyfél</p>
              </div>
