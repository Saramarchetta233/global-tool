...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "30-dnevna Garancija",
      description: "Zadovoljni ali 100% vračilo denarja"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Sledljiva Dostava",
      description: "Po SMS-u boste prejeli številko za sledenje"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Služba za Stranke",
      description: "Namenjena pomoč za vse vaše potrebe"
    }
  ];
  ...
  const nextSteps = [
    {
      step: "1",
      title: "Preveritveni Klic",
      description: "Naš operater vas bo v naslednjih urah kontaktiral za potrditev podatkov naročila",
      time: "Kmalu"
    },
    {
      step: "2",
      title: "Priprava Naročila",
      description: "Vaš izdelek skrbno pripravimo in zapakujemo v našem skladišču",
      time: "24 ur"
    },
    {
      step: "3",
      title: "Ekspresna Dostava",
      description: "Brezplačna dostava z ekspresnim kurirjem, številka za sledenje v paketu",
      time: "24-48 ur"
    }
  ];
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          {orderData?.orderId && (
            <p className="text-lg mt-2 opacity-80">
              Številka Naročila: <strong>{orderData.orderId}</strong>
            </p>
          )}
        </div>
      </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-6 border-2 border-green-200">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-bold text-green-700">
                    Naslednji Preveritveni Klic
                  </h3>
                  <p className="text-green-600">
                    Naš operater vas bo v naslednjih urah kontaktiral
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-300">
                <p className="text-gray-700 text-center">
                  <strong className="text-green-600">📞 Imejte telefon pri roki!</strong><br />
                  Operater bo preveril vaše podatke in potrdil dostavo za zagotovitev popolne dostave.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            <p className="text-center text-gray-700 mb-6 text-lg">
              Naročeno <strong>DANES</strong> in dostavljeno med <strong>{deliveryDates.deliveryRange}</strong>
            </p>
            <div className="flex justify-between items-center">
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📦</div>
                <div className="font-medium text-gray-800">Naročeno</div>
                <div className="text-gray-500 text-sm">{deliveryDates.orderDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">🚚</div>
                <div className="font-medium text-gray-800">Poslano</div>
                <div className="text-gray-500 text-sm">{deliveryDates.shipDate}</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-4xl mb-2">📍</div>
                <div className="font-medium text-gray-800">Dostavljeno</div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-yellow-700 mb-2">
                ⚠️ Pomembne Informacije
              </h3>
              <ul className="space-y-2 text-yellow-700">
                <li>• <strong>Držite telefon vključen</strong> - V naslednjih urah vas bomo poklicali</li>
                <li>• <strong>Preverite svoje podatke</strong> - Operater bo potrdil vaše ime, telefon in naslov</li>
                <li>• <strong>Ni plačila zdaj</strong> - Plača ob prevzemu</li>
                <li>• <strong>Brezplačna dostava</strong> - Brez dodatnih stroškov</li>
                <li>• <strong>Garancija vključena</strong> - 30 dni zadovoljstva ali vračilo denarja</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Pridružili ste se več kot 10.000 Zadovoljnim Strankam
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Sprejeli ste dobro odločitev, ko ste izbrali kakovost in zanesljivost naših izdelkov.
            </p>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg p-4 border-2 border-green-200">
                <div className="text-2xl font-bold text-green-600">98%</div>
                <p className="text-green-700 text-sm">Zadovoljna stranka</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg p-4 border-2 border-blue-200">
                ...
                <p className="text-blue-700 text-sm">Pravočasna dostava</p>
              </div>

              <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg p-4 border-2 border-purple-200">
                <div className="text-2xl font-bold text-purple-600">96%</div>
                <p className="text-purple-700 text-sm">Bi priporočil prijatelju</p>
              </div>
            </div>
          </div>
        </div>
