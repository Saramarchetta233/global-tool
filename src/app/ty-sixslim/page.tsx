      ...
      if (typeof window !== 'undefined' && window.fbq) {
        try {
          window.fbq('track', 'Purchase', {
            ...
            content_name: 'SIX SLIM - Formula Avanzata',
            ...
            <div className="bg-white rounded-lg p-6 shadow-md border border-blue-200">
              ...
              <div className="flex items-center space-x-4">
                ...
                <img
                  ...
                  alt="SIX SLIM Prodotto"
                  className="w-20 h-20 rounded-lg border-2 border-gray-300 object-cover"
                />
                <div className="flex-1">
                  <p className="font-semibold text-gray-800 text-lg">SIX SLIM - Formula Avanzata</p>
                  <p className="text-sm text-gray-600 mb-2">2 Confezioni</p>
