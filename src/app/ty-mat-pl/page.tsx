...
const ThankYouPage = () => {
  ...
  const benefits = [
    {
      ...
      title: "Pompa Automatyczna w Zestawie",
      description: "Szybkie i łatwe nadmuchiwanie bez wysiłku"
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: "Torba Transportowa",
      description: "Praktyczna torba do przechowywania i transportu"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Powierzchnia Welurowa",
      description: "Miękka i przyjemna w dotyku dla maksymalnego komfortu"
    }
  ];
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      description: "Twój materac zostanie starannie przygotowany i zapakowany w naszym magazynie",
      time: "24 godziny"
    },
    {
      step: "3",
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90">
            Dziękujemy za wybór AirNest™ Queen
          </p>
          {orderData?.orderId && (
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              Dołączyłeś do Ponad 15.000 Zadowolonych Klientów
            </h3>

            <p className="text-gray-600 text-lg mb-6">
              Dokonałeś właściwego wyboru komfortu i jakości snu z AirNest™ Queen.
            </p>
